...
<div class="box box-default">
    ...
    <div class="box-body">
        <a class='btn btn-success' href='<?= site_url('admin/posts/create'); ?>'><?= __d('messenger', 'Create a new Post'); ?></a>
    </div>
</div>
...
<div class="box box-default">
    <div class="box-header with-border">
        <h3 class="box-title"><?= __d('messenger', 'Post Threads'); ?></h3>
        <div class="box-tools">
        <?= $threads->links(); ?>
        </div>
    </div>
    ...
    <?php foreach ($threads->getItems() as $thread) { ?>
        ...
        <div class="callout callout-<?= $class; ?>" style="margin: 0 0 10px 0; padding: 10px;">
            <h4><strong><a href="<?= site_url('admin/posts/' . $thread->id); ?>" style="text-decoration: none;"><?= e($thread->subject); ?></a></strong></h4>
            <p><?= e($thread->latestPost->body); ?></p>
...
<div class="alert alert-warning">
    ...
    <?= __d('messenger', 'There are no Post Threads.'); ?>
</div>
